 ...
 function Home(props){
            ...
            <div className="container">
                <div className="row row-content">
                  <div className="col ">
                    ...
                    <button type="button" data-toggle="modal" data-target="#bookingModal">Book a Tour</button>
             </div>
            </div>
            <div className="col ">
  ...
  <div className="row row-content">
    <div className="col-3 col-md ">
        ...
        <img className="tour" width="300px" alt="/" src="https://assets.vogue.com/photos/5891f9739c1609bf7a72f48c/master/w_2560%2Cc_limit/00-art-guided-tour-of-san-francisco.jpg" />
       
      <h3> Soma</h3>
    </div>
    <div className="col-6 col-md">
    
        <img className="tour" width="200px" alt="" src="https://www.shoreexcursionsgroup.com/img/tour/AKSFCSSASHOHOP-2.jpg" />
      <h3>Embarcadero</h3>
    </div>
    <div className="col-3 col-md">

       <img className="tour" width="300px" alt="/" src= "https://www.e-biketours.net/imag/ggb/palace-of-fine-arts.webp" /><h3>North Beach</h3>
    </div>
  </div>
  </div>
</section>
